...
## Purpose
TBD - created by archiving change redesign-pmspec-v2. Update Purpose after archive.
## Requirements
### Requirement: 项目初始化
...
- **WHEN** 执行 `pmspec add feature --epic EPIC-001 --title "Login form"` 后执行 `pmspec list features --epic EPIC-001`
